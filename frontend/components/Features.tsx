...
export default function Features() {
  return (
    <section id="features" className="py-24 px-12 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-center">
      <h2 className="text-5xl font-bold mb-16 bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">
        Why Choose Electric?
      </h2>
